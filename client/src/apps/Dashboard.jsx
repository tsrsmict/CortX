  ...
  return (
    <div className=" absolute overflow-auto dark:bg-dark-purple h-screen w-screen">
      ...
      <div className="flex">
        ...
        <div className="p-1 sm:p-8 sm:mt-200px lg:p-12">
          ...
          <div className='rounded-2xl text-0.25rem flex bg-slate-100 dark:bg-stone-900 m-5 w-11/12 items-center text-center shadow-2xl shadow-zinc-800 mx-auto mt-10'>
              ...
              {TableData.map((row, index) => {
                return (
                  ...
                  <tr key={index} className={` $(color && "shadow-2xl shadow-zinc-800")`}>
                    ...
                    <td className='items-center'><span className='w-11/12 my-7 mx-5'><div className={`w-11/12 h-4.5 rounded-full bg-zinc-200 dark:bg-neutral-800`}>
                      <div class="h-4.5 rounded-full bg-rose-500 dark:bg-rose-700" style={{ width: "30%" }}>30%</div>
                    </div></span></td>

                    <td className=' items-center'><span className='w-full my-7 mx-5'><div className={`w-11/12 h-4.5 rounded-full bg-zinc-200 dark:bg-neutral-800`}>
                      <div class="h-4.5 rounded-full bg-emerald-500 dark:bg-teal-700" style={{ width: "90%" }}>90%</div>
                    </div></span></td>
                  </tr>
                )
              })}
