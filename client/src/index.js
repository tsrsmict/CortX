            ...
            <Router>
                <div>
                    <Routes>
                        ...
                        <Route
                            path="/signup"
                            element={<SignupModule />}></Route>
                        <Route
                            path="/signin"
                            element={<SigninModule />}></Route>
                        <Route
                            path="/logout"
                            element={<LogoutModule />}></Route>

                        <Route path="/tables" element={<Table />}></Route>
                        <Route
                            path="/vaccinations"
                            element={<Vaccination />}></Route>
                        <Route
                            path="/dashboard"
                        ...
                        <Routes
                            ...
                            <Route
                                path="/add-contact"
                                element={<AddContact />}></Route>
                            <Route
                                path="/add-medicine"
                                element={<AddMedicine />}></Route>
                            <Route
                                path="/calendar"
                                element={<Calendar />}></Route>
                            <Route
                                path="/calendar/add"
                                element={<AddReminder />}></Route>
                            <Route
                                path="/dashboard/CortoComp"
                                element={<CortoComp />}></Route>
                            <Route
                                path="/remindermake"
                                element={<ReminderMake />}></Route>
                            <Route
