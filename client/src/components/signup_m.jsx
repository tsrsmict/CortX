  ...
  return (
    <div className="grid min-h-screen bg-sign-up-light dark:bg-sign-up-dark place-items-center">
        <div className="transition ease-in duration-200 hover:backdrop-blur-2xl border-1 border-gray-700 rounded-2xl w-11/12 p-12 bg-sign-up bg-white/[0.7] dark:bg-zinc-900/[0.8] shadow-10xl dark:shadow-zinc-800 sm:w-1/2 lg:w-5/12">
          ...
          <label htmlFor="username" className="block mt-2 text-xs font-semibold text-gray-600 dark:text-white uppercase">Username</label>
            <input id="username" type="text" name="username" placeholder="JohnDeezNuts" autoComplete="username" defaultValue={username} onChange={this.changeHandler} className="block w-full p-3 mt-2 text-gray-700 bg-gray-200 appearance-none focus:outline-none focus:bg-gray-300 focus:shadow-inner" required />
            <br /><br />
            <label htmlFor="email" className="block mt-2 text-xs font-semibold text-gray-600 dark:text-white uppercase">E-mail</label>
            <input id="email" type="text" name="email" placeholder="JohnDoe@gmail.com" autoComplete="email" defaultValue={email} onChange={this.changeHandler} className="block w-full p-3 mt-2 text-gray-700 bg-gray-200 appearance-none focus:outline-none focus:bg-gray-300 focus:shadow-inner" required />
            <br /><br />
